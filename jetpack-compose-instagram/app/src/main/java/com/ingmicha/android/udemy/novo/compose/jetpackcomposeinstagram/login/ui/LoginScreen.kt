...
import com.ingmicha.android.udemy.novo.compose.jetpackcomposeinstagram.R
...
fun Password(password: String, onTextChanged: (String) -> Unit) {
    var passwordVisivility by remember {
    ...
    TextField(
        ...
        trailingIcon = {
            val image = if (passwordVisivility) {
...
fun LoginButton(loginEnable: Boolean, loginViewModel: LoginViewModel) {
    Button(
        onClick = { loginViewModel.onLoginSelected() }, enabled = loginEnable,
        modifier = Modifier.fillMaxWidth(),
...
fun SocialLogin() {
    Row(
        ...
        Text(
            text = "Continue in facebook",
            fontWeight = FontWeight.Bold,
            fontSize = 14.sp,
            modifier = Modifier.padding(8.dp),
            color = Color(0xFF4EA9E9)
        )
    }
}
